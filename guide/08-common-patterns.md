...
See [Build a Simple JSON Parser](crate::guide::worked_json_example) for arrays/objects, and [`examples/json/grammar.rs`](https://github.com/ArneCode/marser/blob/main/examples/json/grammar.rs) for recovery-aware commas.
...
See [Errors and Recovery](crate::guide::errors_and_recovery) and [`examples/mini_language/grammar.rs`](https://github.com/ArneCode/marser/blob/main/examples/mini_language/grammar.rs).
...
- go to [`examples/json/grammar.rs`](https://github.com/ArneCode/marser/blob/main/examples/json/grammar.rs) or [`examples/mini_language/grammar.rs`](https://github.com/ArneCode/marser/blob/main/examples/mini_language/grammar.rs) for full, runnable grammar layouts
